...
3. `markdown-features.md` - GFM, Expressive Code, diagrams (Excalidraw/Mermaid), linking rules
4. `persona.md` - Principal engineer voice and audience

Note: Research and fact-checking guidelines are provided by the global devkit (`guidelines/document/research-and-fact-checking.md`). If the devkit is not available, apply standard research practices: cite authoritative sources, verify claims, and prefer specs over blog posts.
...
For **codebase changes**, use `guidelines/coding/coding-standards.md`.
