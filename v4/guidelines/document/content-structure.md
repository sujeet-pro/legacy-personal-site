...
content/articles/
  <category>/
    ...
    <topic>/
      ...
      <article-slug>/
        README.md            # Article content (main markdown)
        thumbnail.jpg        # Generated thumbnail image
        overview.excalidraw  # Overview diagram source (Excalidraw)
        overview.svg         # Overview diagram rendered
        *.mermaid            # Additional Mermaid diagram sources
        *.excalidraw         # Additional Excalidraw diagram sources
        *.svg                # Rendered SVG diagrams
        *.png / *.jpg        # Other images/screenshots
```
...
Articles use minimal frontmatter. Most metadata is auto-derived (see Derived Fields above).

```yaml
---
lastUpdatedOn: 2025-01-15  # optional, manual override
---
```

### Blogs

Blogs use publication dates and optional tags:

```yaml
---
publishedOn: 2025-01-15
lastUpdatedOn: 2025-01-20  # optional
tags: ["distributed-systems", "observability"]  # optional
---
```

### Projects

Projects use frontmatter for additional metadata (not computed, except `minutesRead`):

```yaml
---
gitRepo: "https://github.com/user/repo"  # optional
links:
  - url: "https://npm.js/package"
    text: "NPM Package"
...
If you need new frontmatter fields beyond these, update:
...
This repo derives metadata from the markdown structure. Follow the article layout defined in `guidelines/document/content-guidelines.md`. Key constraints for the pipeline:
