...
description: JS Engine used by Chrome, Node.js, etc
publishedOn: 2025-02-09
lastUpdatedOn: 2025-02-15
featuredRank: 2
image: ./v8-js-run-overview.png
imageCredit: A simplified view of how V8 works by @addyosmani in the blog "JavaScript Start-up Performance
articleLink: null
category: deep-dives
tags:
  - js
...
import V8JsExecution from './v8-js-execution.svg'

<FigureCaption>
  <V8JsExecution slot='fig' />
