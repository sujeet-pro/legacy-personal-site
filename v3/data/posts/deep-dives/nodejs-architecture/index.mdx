...
description: |
  Node.js's single-threaded event loop and non-blocking I/O model,
  makes it a powerful platform for building scalable, high-performance, and real-time applications.
...
import ReadMorePost from '@/components/post/read-more-post.astro'
...
import v8Flow from './v8-flow.webp'

<ReadMorePost postId='deep-dives/v8-internals' />

<ResponsiveImage
  src={v8Flow}
  alt="V8 Compiler pipeline from the blog Understanding V8's Bytecode by Franziska Hinkelmann"
>
...
import asyncOperations from './async-operations.jpg'

<ResponsiveImage src={asyncOperations} alt='Async Operations Slide by Bert Belder at Node Interactive - 2016'>
  Async Operations Slide by [Bert Belder at Node Interactive
  -2016](https://youtu.be/PNa9OMajw9w?si=VDodCKJ_Xok7YEZY&t=707)
</ResponsiveImage>
...
<ReadMorePost
  postId='deep-dives/nodejs-event-loop'
  prefixTitle='This is an over-simplified explanation. Read more @ '
/>
...
import eventLoopImg from './nodejs-event-loop-with-example.png'

<ResponsiveImage
  src={eventLoopImg}
  alt='Node.js Event Loop Example Diagram by Tyler Hawkins as presented in UtahJS Conf'
>
